...
import {
  Utensils, Store, Sparkles, Globe, ArrowRight, CheckCircle2, Zap,
  Star, ArrowUpRight, QrCode
} from '../ui/Icons';
...
// The public demo business, seeded once via supabase/seed-demo.sql.
const DEMO_SLUG = 'coastal-breeze';
      ...
      <section className="py-24 bg-slate-950 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
              ...
              <button onClick={() => navigate(`/m/${DEMO_SLUG}`)} className="text-orange-400 font-bold hover:text-orange-300 flex items-center gap-2">
